![header](https://capsule-render.vercel.app/api?type=waving&color=auto&height=300&section=header&text=TAEHONG%20KIM&fontSize=90)

### Hi there 👋

안녕하세요! 저는 **김태홍**입니다. 저는 **백엔드 개발자**로 공부하고 있으며, **컴퓨터공학**을 전공했습니다. 저는 **효율적인 코드**를 작성하는 것을 중요하게 생각하며, **좋은 코드**를 작성하기 위해 노력합니다. 또한, **새로운 기술**에 대해 **관심**이 많으며, **학습**을 즐깁니다.

### Experience

- **Brandazine**(2022.06 ~ 2023.09)
  - **Backend Developer**
